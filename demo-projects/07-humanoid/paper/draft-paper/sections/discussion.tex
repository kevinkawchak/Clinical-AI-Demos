...
\path{demo-projects/07-humanoid/paper/instructions/README.md} and
...
\begin{itemize}
  \item ``On-premises repository based LLMs provide commands to
        ...
        \path{codegen/src/llm_planner.py},
        \path{codegen/src/broadcaster.py}, and
        \path{codegen/src/comms_intellectual.py}.
  \item ``based on real-time sensor data'' is supported by
        \path{codegen/src/sensor_to_xyz.py} and
        \path{codegen/src/peer_state_tracker.py}.
  \item ``controlled via x, y, z coordinates'' is supported by
        \path{codegen/src/cartesian_planner.py},
        \path{codegen/src/kinematics.yaml}, and
        \path{codegen/src/xyz_safety.py}.
  \item ``to administer synergistic treatment to patient adverse
        events'' is supported by
        \path{codegen/src/ctcae_grader.py} and
        \path{codegen/src/physician_escalation.py}.
  \item ``This workflow minimizes single robot error potential'' is
        supported by the 191 line
        \path{codegen/src/swarm_coordinator.py} (the camaraderie
        factor of 3).
\end{itemize}
...
\begin{itemize}
  \item \path{demo-projects/07-humanoid/paper/codegen/src/kinematics.yaml}.
  \item \path{demo-projects/07-humanoid/paper/codegen/src/cartesian_planner.py}.
  \item \path{demo-projects/07-humanoid/paper/codegen/src/xyz_safety.py}.
  \item \path{demo-projects/07-humanoid/paper/codegen/tests/test_xyz_safety.py}.
\end{itemize}
...
\begin{itemize}
  ...
  \item \path{demo-projects/07-humanoid/paper/codegen/src/iterate.py}
        and \path{demo-projects/07-humanoid/paper/codegen/src/compare_agent.py}.
  \item Author's December 2025 paper
        \path{kawchak_2025_18029100}: ``Code Generation
...
\begin{itemize}
  ...
  \item \path{demo-projects/07-humanoid/paper/codegen/src/ctcae_grader.py}.
  \item \path{demo-projects/07-humanoid/paper/codegen/src/check_errors.py}
...
trees in
\path{demo-projects/07-humanoid/paper/inputs/Deep-Research-A/} and
...
\begin{itemize}
  \item Deep-Research-A is the Medical Full Automation A source
        ...
        \path{chunk1_paper_text.md},
        \path{chunk2_tables_references.md},
        \path{chunk3_bibtex.md}.
  \item Deep-Research-B is the Medical Rapid Prototyping B source
        bundle: \path{chunk_01_executive_summary_and_fully_automated_sponsor.md},
        \path{chunk_02_federated_learning_and_patient_prediction.md},
        \path{chunk_03_clinagent.md},
        \path{chunk_04_comparative_overview_and_implications.md},
        \path{chunk_05_bibtex_references.md}.
\end{itemize}
...
OnPrem & D2 & 2 & planner, prompt & Quality, safety & 2 pages & Audit trail & Ready \\
Cartesian & D3 & 3 & kinem, planner & Contract & 2 pages & Constants review & Ready \\
Iteration & D4 & 4 & iter index & 32 sweep & 2 pages & 2025 cite & Ready \\
Regulator & D5 & 5 & rtct, ctcae & Advocacy & 2 pages & HR 9505 & Ready \\
Prior & D6 & 6 & DR-A, DR-B & Successor & 2 to 3 pages & Both named & Ready \\
}
