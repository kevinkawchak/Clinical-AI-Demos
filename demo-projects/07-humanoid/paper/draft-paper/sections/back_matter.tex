...
\begin{itemize}
  \item Source code: \texttt{demo-projects/07-humanoid/paper/codegen/src/}
        (27 files spanning Python, C++, Rust, YAML, and Markdown).
  \item Tests: \texttt{demo-projects/07-humanoid/paper/codegen/tests/}
        (notably \texttt{test\_xyz\_safety.py}).
  \item Schemas: \texttt{demo-projects/07-humanoid/paper/codegen/schemas/}.
  \item Configs: \texttt{demo-projects/07-humanoid/paper/codegen/config/}.
  \item Data: \texttt{demo-projects/07-humanoid/paper/codegen/data/}
        and \texttt{demo-projects/07-humanoid/paper/execution/data/}.
        The iteration index lives at
        \texttt{codegen/data/iterations/index.jsonl}. The DuckDB
        aggregate lives at
        \texttt{execution/data/iterations\_aggregate.duckdb}. The
        per-site decision streams live in
        \texttt{execution/data/site\_runtime\_runs/} as
        \texttt{AT-01\_llm\_decisions.jsonl},
        \texttt{BO-01\_llm\_decisions.jsonl},
        \texttt{SD-01\_llm\_decisions.jsonl}, and
        \texttt{SF-01\_llm\_decisions.jsonl}.
  \item Reports: \texttt{demo-projects/07-humanoid/paper/codegen/reports/}
        and \texttt{demo-projects/07-humanoid/paper/execution/reports/}.
        The interpretability dashboard lives at
        \texttt{codegen/reports/dashboard.html}.
  \item ASCII diagrams:
        \texttt{demo-projects/07-humanoid/paper/codegen/diagrams/}
        and
        \texttt{demo-projects/07-humanoid/paper/execution/diagrams/}.
  \item Figures: \texttt{demo-projects/07-humanoid/paper/execution/figures/}
        (6 PNGs at 300 dpi).
  \item Instructions tree:
        \texttt{demo-projects/07-humanoid/paper/instructions/}
        with subdirectories \texttt{00-project-overview/} through
        \texttt{09-runtime-instructions/}.
  \item Prior paper inputs:
        \texttt{demo-projects/07-humanoid/paper/inputs/} including
        \texttt{Deep-Research-A/} and \texttt{Deep-Research-B/}.
  \item Companion repository:
        \texttt{https://github.com/kevinkawchak/physical-ai-oncology-trials},
        with hours 00 through 55 of
        \texttt{new-trial/national-24-7-trial/} included as input
        and hours 56 through 83 excluded per the instructions
        README.
\end{itemize}

Close the paragraph by linking to the project DOI placeholder
\texttt{https://doi.org/10.5281/zenodo.xxxxxxxx} and to the
instructions DOI \texttt{https://doi.org/10.5281/zenodo.18445179}.]
...
Acks & B1 & 1 & Anthropic, OpenAI, Google & Transparent record & Acknowledgments & AI disclosure & Ready \\
