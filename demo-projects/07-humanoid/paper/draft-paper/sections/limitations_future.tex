...
\begin{itemize}
  \item \texttt{demo-projects/07-humanoid/paper/codegen/src/fda\_rtct\_submitter.py}
        ...
        signature).
  \item \texttt{demo-projects/07-humanoid/paper/codegen/src/robot\_loop.cpp}
        (the in-robot 10 Hz loop runs in a simulator harness, not on
        the H2 EDU body).
  \item \texttt{demo-projects/07-humanoid/paper/codegen/src/sensor\_to\_xyz.py}
...
\texttt{demo-projects/07-humanoid/paper/instructions/README.md}. The
original Prompt 07 extra hours dataset (hour 56 through hour 83 under
\texttt{physical-ai-oncology-trials/new-trial/national-24-7-trial/extra-hours/})
...
\texttt{demo-projects/07-humanoid/paper/instructions/README.md}. The
\texttt{10-repository-update-instructions/} subdirectory is named in
...
\begin{itemize}
  ...
  \item \texttt{demo-projects/07-humanoid/paper/inputs/Deep-Research-A/chunk2\_tables\_references.md}
        for the Medical Full Automation A roadmap items.
  \item \texttt{demo-projects/07-humanoid/paper/inputs/Deep-Research-B/chunk\_04\_comparative\_overview\_and\_implications.md}
        for the Medical Rapid Prototyping B roadmap items.
  \item Author's December 2025 paper
        \texttt{kawchak\_2025\_18029100} for the prior limitations
...
\begin{itemize}
  \item Move from simulator harness to a real Unitree H2 EDU body
        ...
        \texttt{codegen/src/kinematics.yaml} as the live target.
  \item Replace the placeholder signature in
        \texttt{codegen/src/fda\_rtct\_submitter.py} with the real
        ed25519 signing chain.
  \item Enroll a real PAT-NET-001 cohort under an IRB protocol and a
        signed sponsor agreement.
  \item Add the
        \texttt{instructions/10-repository-update-instructions/}
        directory.
...
SimGap & L1 & 1 & robot\_loop plus submitter & Sim versus real bound & 1 to 2 pages & No real H2 body run & Ready \\
ByteParity & L2 & 2 & site\_runtime\_runs/ & Identity check noted & 1 page & 62,330 bytes each & Ready \\
Excluded & L3 & 3 & instructions README Notes & Hour 56 to 83 gap & 1 page & Excluded by README & Ready \\
Missing & L4 & 4 & instructions README structure & 10-repo-update dir gap & 1 page & Named not present & Ready \\
Future & L5 & 5 & inputs README plus DR-A and DR-B & Roadmap enumeration & 2 to 3 pages & 7 explicit items & Ready \\
}
