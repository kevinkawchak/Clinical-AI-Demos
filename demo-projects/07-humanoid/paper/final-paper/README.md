...
This directory holds the full LaTeX paper [**Threefold Humanoid 24/7 Adverse Event Oncology Trial Response Team: 4-Site Rotation**](https://doi.org/10.5281/zenodo.20303281), expanded from the v0.6.0 bracketed draft scaffold at `paper/draft-paper/` into the finished v0.7.0 manuscript.
